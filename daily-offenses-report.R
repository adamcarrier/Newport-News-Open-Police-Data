...
getDailyOffensesReport <- function(workingDirectory,dataSetDirectory="./data/") {
    require(ggmap)
    ...
    data <- data[,c("Report", "Date", "Time", "Address", "Offense", "Status", "Disposition", "ReportingArea", "Officer", "Longitude", "Latitude")] # new column order
