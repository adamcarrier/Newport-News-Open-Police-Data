...
If you don't install [Pandoc](https://pandoc.org/installing.html), you'll still get the `index.html` file, but you'll also get a subfolder in the repo with all the assets needed to run Leaflet--it's quite a lot of files.
